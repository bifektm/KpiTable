    ...
    (function (extensibility) {
        ...
        (function (visual) {
            ...
            (function (PBI_CV_19182E25_A94F_4FFD_9E99_89A73C9944FD) {
                ...
                PBI_CV_19182E25_A94F_4FFD_9E99_89A73C9944FD.getCategoricalObjectValue = getCategoricalObjectValue;
                /**
                 * logExceptions
                 */
                ...
                PBI_CV_19182E25_A94F_4FFD_9E99_89A73C9944FD.logExceptions = logExceptions;
...
(function (STYLE) {
    var Customize = (function () {
         ...
         * zoom of visual
         */
        Customize.setFontsize = function (tHead, num) {
         ...
         * set color font
         */
        Customize.setColorFont = function (tHead, color) {
            if (tHead) {
                if (color == undefined || color == null) {
        ...
        * set size font rows
        */
        Customize.setFamily = function (tBody, font) {
            if (tBody) {
...
(function (ICON) {
    ...
    */
    var ShapeFactory = (function () {
         ...
         * @param  {string} shape
         */
        ShapeFactory.getShape = function (shape) {
            if (shape == null) {
            ...
            (function (PBI_CV_19182E25_A94F_4FFD_9E99_89A73C9944FD) {
                var Visual = (function () {
                    ...
                    Visual.prototype.setHeaders = function () {
                        ...
                        var rows = this.dataview.categorical.categories;
                        //insert header row
                    ...
                    Visual.prototype.setConfigRows = function (type, value, k, pol) {
                        ...
                        if (type == strucData.Type.SCORE) {
                            ...
                            if (iconType == strucData.IconType.ICON) {
                                ...
                                row.value = COMMON.Core.formatNumber(value)
    ...
    (function (visuals) {
        ...
        (function (plugins) {
            plugins.PBI_CV_19182E25_A94F_4FFD_9E99_89A73C9944FD_DEBUG = {
                ...
                version: '1.0.0',
                apiVersion: '1.5.0',
                create: function (options) { return new powerbi.extensibility.visual.PBI_CV_19182E25_A94F_4FFD_9E99_89A73C9944FD.Visual(options); },
                custom: true
            };
